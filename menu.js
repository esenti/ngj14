...
MenuState = {
	enter: function() {
		if (cablecurva) { $('body').append('<div class="cables" style="top:-200px; left:300px;"><div class="cable"></div><div class="cable2"></div><div class="cable cable3"></div><div class="cable2 cable4"></div><div class="cable cable5"></div><div class="cable2 cable6"></div></div>'); }
		$('body').append('<div id="awrapper" style="height:500px"><div id="mtext" style="overflow: hidden;"><div id="mscreen"></div></div><div id="menuitems"><div class="wcklogo">Words&nbsp;&nbsp;can&nbsp;&nbsp;kill</div><div class="wcklogo" style="font-size: 28px; padding: 10px 0;">main&nbsp;&nbsp;menu</div><br><a class="button glass orange skew xl menubut singleplayer">single player</a><br><br><a class="button glass orange skew xl menubut local">multiplayer (local)</a><br><br><a class="button glass orange back xl menubut host" style="width: 460px">multiplayer (host)</a><a class="button glass orange shield xl menubut join" style="width: 410px">multiplayer (join)</a><input type="text" id="join-code">code</input></div><a class="button glass oval orange xl page" data-page="2">+</a></div>');
